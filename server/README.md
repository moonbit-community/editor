...
- Manage file watches, close/dispose behavior, hover and definition requests,
  raw LSP packet routing, and remote protocol dispatch.

## Boundaries

- May depend on `core`, `workspace`, `language`, and `remote_protocol`.
