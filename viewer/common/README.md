...
This package may depend on `viewer/common/view_layout` and
`viewer/common/view_model`; it must remain DOM/FFI/host independent and build for
JS and native. The complete surface is `pkg.generated.mbti`; run
